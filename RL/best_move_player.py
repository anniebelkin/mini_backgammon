...
class BestOfFourHuristicStrategy(Strategy):
    def __init__(self):
        super().__init__()
...
class BestOfFourHardStrategy(Strategy):
    def __init__(self):
        super().__init__()
        self.evaluate_board = CompareAllMovesWeightingDistanceAndSinglesWithEndGame2().evaluate_board
